...
impl AppConfig {
    pub fn load_from_env() -> Result<Self> {
        let grpc_port =
            env::var("SIP_PROXY_SERVICE_GRPC_PORT").unwrap_or_else(|_| "13071".to_string());
        let http_port =
            env::var("SIP_PROXY_SERVICE_HTTP_PORT").unwrap_or_else(|_| "13070".to_string());
        let sip_port_str =
            env::var("SIP_PROXY_SERVICE_SIP_PORT").unwrap_or_else(|_| "13074".to_string());
        ...
        let internal_users_raw =
            env::var("CORE_INTERNAL_SERVICE_USERS").unwrap_or_else(|_| "b2bua".to_string());
        ...
        Ok(AppConfig {
            ...
            sip_port,
            proxy_advertised_host: env::var("SIP_PROXY_SERVICE_ADVERTISED_HOST")
                .unwrap_or_else(|_| "sip-proxy-service".to_string()),
            public_ip,
            ...
            user_service_grpc_url: env::var("USER_SERVICE_TARGET_GRPC_URL")
                .unwrap_or_else(|_| "https://user-service:12011".to_string()),
            redis_url: env::var("REDIS_URL").context("REDIS_URL eksik")?,
            b2bua_sip_addr: env::var("B2BUA_SERVICE_SIP_TARGET")
                .context("B2BUA_SERVICE_SIP_TARGET eksik")?,
